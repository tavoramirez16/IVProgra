 ...
 * @author yoorda
 */
public class GuiEspecialidades extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldDescripcion.setBounds(100, 270, 190, 20);
        ...
        jScrollPane2.setBounds(310, 160, 260, 190);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuiEspecialidades.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GuiEspecialidades().setVisible(true);
            }
        });
    }
