 ...
 * @author yoorda
 */
public class GuiServicios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldNombre.setBounds(100, 230, 190, 20);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuiServicios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GuiServicios().setVisible(true);
            }
        });
    }
